...
parser.add_argument("--output_file", type=str, default="output/phase_2/agentic_filtering/hulu_med_4b.jsonl", help="The file to save the model's predictions to.")
    ...
    for emotion in emotion_list:
        for conv_mode in conv_modes:
            ...
            for sample in tqdm(samples, desc=f"Processing {emotion} - {conv_mode}"):
                ...
                modal = 'text'
                inputs = processor(
                    conversation=extraction_messages,
                    return_tensors="pt",
