...
MODEL_PATH=${MODEL_PATH:-meta-llama/Llama-3.2-11B-Vision-Instruct}
OUTPUT_FILE=${OUTPUT_FILE:-output/smoke_test/llama32_vision_instruct_11b.jsonl}
DEVICE=${DEVICE:-cuda}
...
do
    ...
    "$PYTHON" models/run_llama32_vision.py \
